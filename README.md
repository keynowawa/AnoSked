...
AnoSked? has no account system and does not upload pasted enrollment text. Subjects, tasks, optional profile details, and preferences are stored in the browser on the current device. After consent, an anonymous analytics service counts page views without receiving schedule content.
