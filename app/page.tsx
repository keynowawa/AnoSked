      ...
      <section className="app-main" id="main-content" tabIndex={-1}>
        ...
        {view === "settings" && (
          <div className="page settings-page">
            ...
            <div className="local-disclosure"><Icon name="about" size={17} /><div><strong>Your schedule stays on this device</strong><span>After you agree, AnoSked counts anonymous page views to understand how the app is used. Subjects, tasks, enrollment text, and profile details are never included.</span></div></div>
          </div>
        )}
